...
class _TabFeedState extends State<TabFeed> {
  Future getUserData(value) async {
    var url = Uri.parse(
        'https://factchecktools.googleapis.com/v1alpha1/claims:search?languageCode=en&key=AIzaSyC9qBbkNUZlmPzt1T-66UUf9R8k5Iqx3xY&query={${widget.value}');
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return CustomCard(
                        index: i,
                        title: data[i].text,
                        description: data[i].url,
                        textualRating: data[i].textualRating,
                      );
                    });
              }
            },
